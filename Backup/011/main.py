...
def main(screen):
    ...
    sword_surface = pygame.image.load("dg_weapons32_sword.gif")
    sword_surface = pygame.transform.scale(sword_surface, (64, 64))
    sword_surface.set_colorkey(colorWhite)
                ...
                if hero_makes_decision:
                    ...
                    if hero.intent.type is intent.MOVE:
                        ...
                        handle_attack(hero, hero.intent.target,
                                      message_log, map_data, entities_in_combat, reaction_order, sword_surface= sword_surface)
